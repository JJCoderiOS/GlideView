...
@property (strong, nonatomic) DeliverTableViewController *readedDeliverVC;
...
- (void)setupTableView
{
    ...
    allDeliverVC.deliverType = DeliverTypeALL;
    self.allDeliverVC = allDeliverVC;
    
    //已读
    DeliverTableViewController *readedDeliverVC = [[DeliverTableViewController alloc]initWithStyle:UITableViewStyleGrouped];
    readedDeliverVC.deliverType = DeliverTypeRE;
    ...
    interviewDeliverVC.deliverType = DeliverTypeIN;
    ...
    noMatchingDeliverVC.deliverType = DeliverTypeRJ;
...
- (void)viewDidLayoutSubviews
{
    ...
    self.allDeliverVC.view.frame = CGRectMake(Gap, 0, SCREEN_WIDTH, height);
    self.readedDeliverVC.view.frame = CGRectMake(width + Gap, 0, SCREEN_WIDTH, height);
    self.interviewDeliverVC.view.frame = CGRectMake(width * 2 + Gap, 0, SCREEN_WIDTH, height);
    self.noMatchingDeliverVC.view.frame = CGRectMake(width * 3 + Gap, 0, SCREEN_WIDTH, height);
